...
OM_MapCanvasDetailLayerMixin = {};

function OM_MapCanvasDetailLayerMixin:OnLoad()
	self.detailTilePool = CreateTexturePool(self, "BACKGROUND", -7, "OM_MapCanvasDetailTileTemplate");
	self.textureLoadGroup = CreateFromMixins(TextureLoadingGroupMixin);
end

function OM_MapCanvasDetailLayerMixin:SetMapAndLayer(mapID, layerIndex)
...
function OM_MapCanvasDetailLayerMixin:GetLayerIndex()
	return self.layerIndex;
end

function OM_MapCanvasDetailLayerMixin:IsFullyLoaded()
	return not self.isWaitingForLoad;
end

function OM_MapCanvasDetailLayerMixin:SetLayerAlpha(layerAlpha)
	self.layerAlpha = layerAlpha;
	self:RefreshAlpha();
end

function OM_MapCanvasDetailLayerMixin:GetLayerAlpha()
	return self.layerAlpha or 1;
end

function OM_MapCanvasDetailLayerMixin:SetGlobalAlpha(globalAlpha)
	self.globalAlpha = globalAlpha;
	self:RefreshAlpha();
end

function OM_MapCanvasDetailLayerMixin:GetGlobalAlpha()
	return self.globalAlpha or 1;
end

function OM_MapCanvasDetailLayerMixin:RefreshDetailTiles()
...
function OM_MapCanvasDetailLayerMixin:OnUpdate()
...
function OM_MapCanvasDetailLayerMixin:RefreshAlpha()
